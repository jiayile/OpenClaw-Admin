import{n as W,av as j,aw as q,ax as O,ay as G,az as A,m as z,f as a,g as w,h as M,i as T,k as L,aA as X,a9 as D}from"./index-DJbcn0rV.js";import{j as B,k as r,c as b}from"./vue-vendor-J9QZ-CeD.js";import{f as k}from"./text-BFgT2WD4.js";const Y={success:r(G,null),error:r(O,null),warning:r(q,null),info:r(j,null)},_=B({name:"ProgressCircle",props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(e,{slots:u}){const g=b(()=>{const o="gradient",{fillColor:t}=e;return typeof t=="object"?`${o}-${A(JSON.stringify(t))}`:o});function y(o,t,n,d){const{gapDegree:p,viewBoxWidth:f,strokeWidth:h}=e,l=50,m=0,s=l,i=0,x=2*l,$=50+h/2,v=`M ${$},${$} m ${m},${s}
      a ${l},${l} 0 1 1 ${i},${-x}
